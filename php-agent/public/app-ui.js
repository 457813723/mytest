(function ($, D, doc, win){
    ...
    D._mix(D, {
        ...
        API: (() => {
            return {
                // 获取用户信息
                INDEX_USER_INFO: '/api/baseinfo.php',
                // 生成二维码
                CREATE_QRCODE: '/api/create_qrcode',
                // 推广佣金提现 统计数据
                CAN_CARRY_INFO: '/api/incomedetail.php',
                // 收益提现记录
                OPERATE_RECORD: '/api/deposit_record.php',
                // 提现
                DISTRIBUTE_TO_GAMES: '/api/distribute_to_games.php',
                // 我的茶楼
                SUBORDINATE: '/api/xiaxian.php',
                // 添加代理
                OPEN_AGENT: '/api/addAgent.php',
                // 今日新增扫码
                NEW_SCAN_TODAY: '/api/new_scan_today',
                //推广收益
                GENERALIZE_TODAY_TOTAL: '/api/agent_income.php',
                // 大区收益明细
        ...
        goIndex: function (){
            var gsHref = {
                ...
                index: "../../index.html"
                // 二维码
                , code_scanning: "./pages/code_scanning/code_scanning.html"
                //推广佣金提现
                , extract_withdrawal_benefit: "../../pages/extract_withdrawal_benefit/extract_withdrawal_benefit.html"
                //我的茶楼
                , my_club: "./pages/my_club/my_club.html"
                // 今日新增扫码
                , new_scan_today: "./pages/new_scan_today/new_scan_today.html"
                //今日推广收益
                , income_details: "./pages/income_details/income_details.html"
                // 大区收益明细
                ...
                //赠送亲友
                , givefriend: "./pages/give_friend/give_friend.html"
                //历史记录
