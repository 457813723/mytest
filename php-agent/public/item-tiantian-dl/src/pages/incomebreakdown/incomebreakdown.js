    ...
    GS._mix(GS, {
        ...
        getListDataFromNet: function (pageNum, pageSize, successCallback, errorCallback){
            ...
            G.ajax({
                ...
                $('.total-performance-1').text(data.ret.totalInfo.totalAch);
                $('.total-performance-2').text(data.ret.totalInfo.regionAch);
//                data.ret.rows = [
//                    {
//                        agentId: 'agentId',
//                        agentName: 'agentName',
...
//                ];
    ...
    $('body')
    //搜索
        .on('click', '#aui-flex-button-btn', function (){
    ...
    //菜单显示
    $('body').on('click', '.gs-js-item', function (){
